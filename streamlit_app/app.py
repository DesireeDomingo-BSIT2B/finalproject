...
MODEL_URL = "https://github.com/DesireeDomingo-BSIT2B/finalproject/blob/main/"
...
@st.cache_resource
def load_model():
    download_model(MODEL_URL, 'save_model.keras')
    model = tf.keras.models.load_model('save_model.keras')
